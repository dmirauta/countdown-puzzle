...
int main(int argc, char* argv[]) {
    ...
    // Setup data
    SynchronisedArray<GameSet_t>   gamesets(ecl.context, CL_MEM_READ_ONLY, {MAX_GAMESETS});
    SynchronisedArray<Reachable_t> reachable_arrs(ecl.context, CL_MEM_WRITE_ONLY, {MAX_GAMESETS});
